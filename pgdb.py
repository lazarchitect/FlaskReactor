...
sql = {
        ...
        "updateChessGame": "UPDATE " + relation + ".chess_games SET boardstate=%s, last_move=%s, player_turn=%s, notation=%s, blackKingMoved=%s, whiteKingMoved=%s, bqrMoved=%s, bkrMoved=%s, wqrMoved=%s, wkrMoved=%s WHERE id=%s",
